AhkExported(mapping:=""){
  static init
  static functions:="ahkFunction:s==sssssssssss|ahkPostFunction:s==sssssssssss|ahkExec:ui==s|ahkassign:ui==ss|ahkExecuteLine:t==tuiui|ahkFindLabel:t==s|ahkgetvar:s==sui|ahkLabel:ui==sui|ahkPause:i==s"
  If !init&&init:=Object(){
    If !A_IsCompiled
